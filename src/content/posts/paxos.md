---
title: Paxos
pubDatetime: 2025-09-29T21:52:55+05:30
draft: false
tags:
  - consensus
  - distributed-systems
...
order: 2
description: A walkthrough of the Paxos consensus algorithm — its prepare/promise/accept phases and why ballot numbers must stay unique across nodes.
---

Paxos is a simple [Consensus](/posts/consensus/) algorithm that was introduced by Leslie Lamport. It serves as a building block for multiple other consensus algorithm. You can read more about it [here](https://lamport.azurewebsites.net/pubs/paxos-simple.pdf)
