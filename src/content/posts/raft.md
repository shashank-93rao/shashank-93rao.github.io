---
title: Raft
pubDatetime: 2025-09-30T21:48:51+05:30
draft: false
tags:
  - consensus
  - distributed-systems
...
order: 4
description: Leader election, log replication, and commit semantics in Raft — a consensus algorithm designed as an easier-to-understand alternative to Paxos.
---

Raft is one of the most popular [Consensus](/posts/consensus/) algorithm that's present today. Can read more about it [here](https://raft.github.io/raft.pdf).

Built as an alternative to the [Paxos](/posts/paxos/) group of algorithms, it is built mainly to simplify the understanding of consensus algorithm.
