...
tags:
  ...
  - jit
  - jfr
description: Five lessons from profiling a high-throughput serialization loop — JIT inlining, jump tables vs enum switches, ThreadLocal allocation elimination, and DateTimeFormatter's hidden allocations.
---
